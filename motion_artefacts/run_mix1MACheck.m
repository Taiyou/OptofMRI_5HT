...
%% 1. datapath to the 6 motions data
trans_blue_path = fullfile(pwd, '/mix1st/transgenic/blue');
trans_yell_path = fullfile(pwd, '/mix1st/transgenic/yellow');
wildt_blue_path = fullfile(pwd, '/mix1st/WT/blue');
wildt_yell_path = fullfile(pwd, '//mix1st/WT/yellow');
savepath        = fullfile(pwd, '/figures/motion_artefacts/mix1st');
mkdir(savepath)
