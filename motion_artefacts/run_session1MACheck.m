...
%% 1. datapath to the 6 motions data
trans_blue_path = fullfile(pwd, '/session1/transgenic/blue');
trans_yell_path = fullfile(pwd, '/session1/transgenic/yellow');
wildt_blue_path = fullfile(pwd, '/session1/WT/blue');
wildt_yell_path = fullfile(pwd, '/session1/WT/yellow');
...
g(1,1).set_names('x','motion type','y','difference in mean motion (É m)','color','# Group');
...
g(1,1).set_names('x','motion type','y','difference in std motion (É m^2)','color','# Group');
