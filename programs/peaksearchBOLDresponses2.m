function [maxTIMES1, maxTIMES2, maxTIMES1id, maxTIMES2id, maxAUC1, maxAUC2, maxAUC1st, maxAUC2nd] = peaksearchBOLDresponses2(BOLDresponse1, BOLDresponse2, ROIname, timedur, stim)
