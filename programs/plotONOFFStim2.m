function [] = plotONOFFStim2(COPE, savename, savepath)
...
gf.axe_property('XTickLabelRotation',90);
gf.axe_property('YTickLabelRotation',90);
gf.axe_property('YLim',[-1 4]);
gf.set_order_options('x',0);
figure('Position',[100 100 1800 600]);
%gf.coord_flip();
blue = [0.0, 1, 1];
gf.set_color_options('map', blue, 'lightness', 50)
gf.draw();
